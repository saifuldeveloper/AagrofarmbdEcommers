    ...
    public function update($request)
    {
        ...
        foreach($image_files as $image_file){
            if ($file = $request->file($image_file)) {
                $input[$image_file] = ImageHelper::handleGeneralSettingsUpdatedUploadedImage($file,'assets/images/generalSettingsImages/',$data,'assets/images/generalSettingsImages/',$image_file);
            }
        }
