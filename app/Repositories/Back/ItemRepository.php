...
class ItemRepository
{
    ...
    {
        ImageHelper::handleDeletedImage($gallery, 'photo', '/assets/images/productImages/');
        $gallery->delete();
    }
    ...
    public function storeImageData($request, $item_id = null)
    {
        ...
        if ($galleries = $request->file('galleries')) {
            foreach ($galleries as $key => $gallery) {
                $storeData[$key] = [
                    'photo' =>  ImageHelper::handleUploadedImage($gallery, 'assets/images/productImages/'),
