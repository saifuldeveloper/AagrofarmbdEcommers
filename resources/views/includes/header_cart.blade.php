...
@endphp
<div class="entry">
  <div class="entry-thumb"><a href="{{route('front.product',$cart['slug'])}}"><img src="{{asset('assets/images/productImages/'.$cart['photo'])}}" alt="Product"></a></div>
...
<div class="w-50 d-block text-end"><a class="btn btn-primary btn-sm  mb-0" href="{{ url('/checkout/review/payment') }}"><span>{{__('Checkout')}}</span></a></div>
@else
{{__('Cart empty')}}
  @endif
</div>
