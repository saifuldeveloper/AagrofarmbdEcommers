      ...
      <div class="col-xxl-5 col-lg-6 col-md-6">
        <div class="product-gallery">
          ...
          <div class="product-thumbnails insize">
            ...
            <div class="item"><img src="{{asset('assets/images/productImages/'.$item->photo)}}" alt="image"  /></div>
            @foreach ($galleries as $key => $gallery)
            <div class="item"><img src="{{asset('assets/images/productImages/'.$gallery->photo)}}" alt="image"  /></div>
            @endforeach
        </div>
      </div>
        </div>
