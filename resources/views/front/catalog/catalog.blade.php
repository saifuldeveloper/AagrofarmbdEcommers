                ...
                @if ($checkType != 'list')
                    ...
                    <div class="col-xxl-3 col-md-4 col-6">
                        ...
                        <div class="product-thumb">
                            <img class="lazy"  src="{{asset('assets/images/productImages/'.$item->photo)}}" alt="Product">
                        ...
                        <div class="product-card-body">
                            ...
                            <br>
                            <a  class="btn btn-primary m-0"  data-item="{{  $item->id }}" id="but_to_cart"><i class="icon-bag"></i><span>{{ __('Buy Now') }}</span></a>
