                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="theme" id="select_theme">
                                                                <option value="theme1" {{$setting->theme == 'theme1' ? 'selected' : ''}} >{{__('Home')}}</option>
                                                            ...
                                                            <div class="col-lg-12 ">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-12 pb-1">
                                                                        <img class="admin-setting-img"
                                                                            src="{{ $setting->logo ? asset('assets/images/generalSettingsImages/'.$setting->logo) : asset('assets/images/placeholder.png') }}"
                                                                            alt="No Image Found">
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-12 pb-1">
                                                                            <img class="admin-setting-img my-mw-100"
                                                                                src="{{ $setting->favicon ? asset('assets/images/generalSettingsImages/'.$setting->favicon) : asset('assets/images/placeholder.png') }}"
                                                                                alt="No Image Found">
                                                                        </div>
                                                            ...
                                                            <div class="row justify-content-center">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-12 pb-1">
                                                                            <img class="admin-setting-img my-mw-100"
                                                                                src="{{ $setting->loader ? asset('assets/images/generalSettingsImages/'.$setting->loader) : asset('assets/images/placeholder.png') }}"
                                                                                alt="No Image Found">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group position-relative ">
