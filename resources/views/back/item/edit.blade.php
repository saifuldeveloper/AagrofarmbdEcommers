        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <img class="admin-img lg" src="{{ $item->photo ? asset('assets/images/productImages/'.$item->photo) : asset('assets/images/placeholder.png') }}" >
                    </div>
                            ...
                            <div class="d-block gallery_image_view">
                                ...
                                @forelse($item->galleries as $gallery)
                                    <div class="single-g-item d-inline-block m-2">
                                            ...
                                            <a class="popup-link" href="{{ $gallery->photo ? asset('assets/images/productImages/'.$gallery->photo) : asset('assets/images/placeholder.png') }}">
                                                <img class="admin-gallery-img" src="{{ $gallery->photo ? asset('assets/images/productImages/'.$gallery->photo) : asset('assets/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            </a>
                                    </div>
                                @empty
