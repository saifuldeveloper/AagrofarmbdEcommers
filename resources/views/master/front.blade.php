...
<link rel="icon" type="image/x-icon" href="{{ asset('assets/images/generalSettingsImages/' . $setting->favicon) }}" />
<!-- Favicon Icons-->
...
{{-- @if ($setting->is_loader == 1)
<div id="preloader">
    <img src="{{ asset('assets/images/generalSettingsImages/'.$setting->logo) }}" alt="{{ __('Loading...') }}">
</div>
@endif --}}
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between">
                        <!-- Logo-->
                        <div class="site-branding"><a class="site-logo align-self-center" href="{{route('front.index')}}"><img src="{{asset('assets/images/generalSettingsImages/'.$setting->logo)}}" alt="{{$setting->title}}"></a></div>
                        <!-- Search / Categories-->
                                ...
                                <div class="tab-pane fade show active" id="mmenu" role="tabpanel" aria-labelledby="mmenu-tab">
                                    <nav class="slideable-menu">
                                        <ul>
                                            ...
                                            <li class="{{ request()->routeIs('front.catalog*')  ? 'active' : '' }}"><a href="{{route('front.catalog')}}"><i class="icon-chevron-right"></i>{{__('Product')}}</a></li>
                                            @endif
                    ...
                    <div class="nav-inner">
                        <nav class="site-menu">
                            <ul>
                                ...
                                @if ($setting->is_shop == 1)
                                <li class="{{ request()->routeIs('front.catalog*')  ? 'active' : '' }}"><a href="{{route('front.catalog')}}">{{__('Product')}}</a></li>
                                @endif
                                {{-- @if ($setting->is_campaign == 1)
...
<div id="announcement-modal" class="mfp-hide white-popup">
    @if ($setting->announcement_type == 'newletter')
        <div class="announcement-with-content">
            <div class="left-area">
                <img src="{{ asset('assets/images/generalSettingsImages/'.$setting->announcement) }}" alt="">
            </div>
            <div class="right-area">
...
<style>
  ...
  <div>
        <a href="https://wa.me/8801813570280" class="float" target="_blank">
            <i class="fab fa-whatsapp my-float"></i>
        </a>
    </div>

    <div>
        <a href="https://m.me/" class="float_left" target="_blank">
